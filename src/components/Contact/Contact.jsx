...
const Contact = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: Github, url: 'https://github.com/Safif2000', color: '#ffffff' },
    { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/in/smafif-frontend-developer', color: '#0a66c2' },
            ...
            <motion.div variants={itemVariants} className={styles.info}>
              ...
              >
                ...
                <div>
                  ...
                  <p className={styles.infoText}>Pakistan,Karachi</p>
                </div>
              </motion.div>
